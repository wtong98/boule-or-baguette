...
os.environ['WANDB_PROJECT'] = 'qwen_php'
...
os.environ['WANDB_NAME'] = f'Qwen-7b-coder DP/AR split={split}'
...
# TODO: temporary hard cod
ds_path = '~/workspace/imply/imply/task/prop_gen/data/hf_php_text'
    ...
    with torch.no_grad():
        ...
        for r, val_ds in tqdm(zip(ranges, val_ds_set), total=len(val_ds_set)):
            ...
            with torch.autocast(device_type='cuda', dtype=torch.bfloat16):
                ...
                preds = trainer.model.generate(**inp, max_new_tokens=10)  # max tokens limited for faster generation
