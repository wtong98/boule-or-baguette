...
train_ds = make_ds(10, 'train')
test_ds = make_ds(10, 'test')
...
args = TrainingArguments(
    output_dir="qwen25_coder7b_prop_qlora", # TODO: pick destination
    num_train_epochs=5,
    ...
    optim="adamw_bnb_8bit",              # QLoRA-friendly optimizer
    max_grad_norm=0.3,
    weight_decay=0.0,
    report_to="none",
)
