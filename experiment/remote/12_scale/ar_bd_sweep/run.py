"""
Relationship between length and width and accuracy in Starfish
"""
...
n_depths = (2**np.linspace(3, 8, num=40)).astype(int) * 2
n_arms = (2**np.linspace(3, 8, num=40)).astype(int) * 2
